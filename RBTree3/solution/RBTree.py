...
def main():
    ...
    bt.visualize()
    bt.create_figure("tree_saved.png")
    bt.save_to_file("tree.json")

    bt2 = RBTree()

    bt2.load_from_file("tree.json")
    bt2.visualize()
    bt2.create_figure("tree_loaded.png")
    print("Checking red-black properties:", bt2.check_red_black_properties())
